...
function divider(numbersArray) {
  var arr = [];
  arr[0] = numbersArray.filter((elem) => elem % 2 === 0);
  arr[1] = numbersArray.filter((elem) => elem % 2 === 1);
  return arr;
}
...
function removeItem(myGroceryList, item) {
  return myGroceryList.filter((elem) => elem !== item);
}
